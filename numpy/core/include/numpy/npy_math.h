...
#define NPY_LOG9Ef    0.45511961F /*for float conversion*/
...
#define NPY_LOG9El    0.45511961 /*long conversion*/
...
NPY_INPLACE double npy_log9(double x);
...
NPY_INPLACE float npy_log9f(float x);
...
NPY_INPLACE npy_longdouble npy_log9l(npy_longdouble x);
